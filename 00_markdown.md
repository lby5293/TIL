...
> 목록을 나열할 때 사용합니다. 순서가 필요한 항목과 그렇지 않은 항목으로 구분할 수 있습니다. 순서가 있는 항목아래 순서가 없는 항목을 지정할 수 있으며 그 반대도 가능합니다.
...
![git사진](C:\Users\lby52\OneDrive\바탕 화면\git사진.png) ![github사진](C:\Users\lby52\OneDrive\바탕 화면\github사진.png)
